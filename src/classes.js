...
const CLASSES = [
  ...
  },
  {
    ...
    cor2: '#8a0f31',
    icone: 'E',
    descricao: 'O maior dano colado do jogo, e a que mais cobra por isso: o dano só existe em cima do inimigo. Escopeta de alcance curtíssimo, dash que corta e cura a cada abate.',
    forcas: ['5 projéteis de 7 de dano por tiro', 'Dash corta quem encostar', 'Cura 2,5% da vida a cada abate', 'CARNIFICINA: a ultimate mais forte do jogo'],
    fraquezas: ['Só 2 corações', 'Alcance curtíssimo: 360 px', 'Errou a distância, morreu'],
    somTiro: 'shotgun',
    ult: { nome: 'CARNIFICINA', descricao: '5 s intangível e cortando: foice de 175 px, ecos que cortam a multidão sozinhos e estouro final do tamanho da chacina. Contra boss vale o corte, não os ecos.' },
    atributos: {
      vidaMax: 2, velocidade: 430, cadencia: 0.34, dano: 7, projeteis: 5,
  ...
  },
  {
    ...
    cor2: '#1d6b45',
    icone: 'I',
    descricao: 'Dois drones caçam sozinhos com dano reduzido enquanto o INVOCADOR sustenta a linha com tiro teleguiado.',
    forcas: ['2 drones automáticos com 65% do dano', '3 corações', 'Tiro teleguiado que atravessa', 'Melhoria própria: até +2 drones'],
